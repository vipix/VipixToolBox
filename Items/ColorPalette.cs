...
namespace VipixToolBox.Items
{
	public class ColorPalette : ModItem
	{
		...
		public override void HoldItem (Player player)
		{
			...
			if (Vector2.Distance(player.position , myPlayer.pointerCoord) < toolRange*16 && myPlayer.spotlight && VipixToolBox.toolEnabled["ColorPalette"])
			{
			...
			VipixToolBox.toolEnabled["ColorPalette"])
			{
